...
│   ├── Notebook04.ipynb -- Correlation network creation from lipidomics and single-cell transcriptomics data from de-identified samples.
│   ├── Notebook05.ipynb -- Diffusion model(SD) implementation and plotting metrics.
│   ├── Notebook06.ipynb -- Small language model and image-to-text generation model implementation and comparative metrics.
